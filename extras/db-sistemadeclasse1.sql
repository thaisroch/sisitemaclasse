...
CREATE TABLE IF NOT EXISTS `db_sistemadeclasse`.`tbl_classe` (
  ...
  `tbl_disciplina_id` INT ZEROFILL NOT NULL,
  ...
  INDEX `fk_tbl_classe_tbl_disciplina` (`tbl_disciplina_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_tbl_escola_id2`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_classe_tbl_disciplina1`
